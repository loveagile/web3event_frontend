    ...
    <header ref={ref}>
      ...
      >
        <div className="container flex flex-row items-center py-4 mx-auto">
          <Link
            href="/"
            className="duration-200 text-violet-500 hover:text-zinc-100 text-4xl font-bold mr-32 whitespace-nowrap"
          >
            Commune AI
          </Link>
          ...
          <div className="flex flex-row justify-between items-center w-full">
            <div className="flex justify-around gap-12 items-center">
              <Link
                href="/explore"
                className="duration-200 py-3 rounded-lg text-violet-500 hover:text-zinc-100 text-center font-medium text-2xl"
              >
                Explore
              </Link>
                      ...
                      >
                        {(() => {
                          if (!connected) {
                            return (
                              <button
                                className="inline-flex cursor-pointer rounded-xl bg-gradient-to-r from-indigo-500 to-indigo-600 py-1.5 px-3 text-white text-lg hover:animate-scaleSlow duration-500 font-semibold w-full"
