      ...
      <article className="p-3 md:p-4">
        <div className="w-full h-[200px] relative rounded-lg overflow-hidden">
          <Image
            ...
            fill={true}
            alt={web3event.title}
            className="hover:brightness-50 object-cover"
          />
        </div>
        <h2 className="z-20 mt-4 text-lg font-medium duration-1000 lg:text-xl text-zinc-300 group-hover:text-white font-display">
          {web3event.title}
        </h2>
        ...
        <span
          className="mt-2 text-xs duration-1000 text-zinc-300 group-hover:text-white 
        ...
        <div className="my-3 flex justify-between gap-2 items-center">
          <span
            className="text-xs duration-1000 text-zinc-300 group-hover:text-white 
